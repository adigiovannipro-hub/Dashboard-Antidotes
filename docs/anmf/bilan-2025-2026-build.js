...
// ---------------------------------------------------------------- 6. ON ARRÊTE
{
  ...
  pill(s, "RECOMMANDATIONS · 1/3", 0.6, 0.2, 2.5, 0.3, OR, WH, 9.5);
...
// ---------------------------------------------------------------- 8. ON AJOUTE
{
  const s = pres.addSlide();
  s.background = { color: CR };
  kicker(s, "RECOMMANDATIONS · 3/3");
  title(s, "On ajoute : le site convertit", { w: 7 });
  ...
  card(s, 0.6, 5.85, 6.75, 1.05, WH);
  text(s, "Et côté social", { x: 0.85, y: 5.93, w: 2, h: 0.3, fontSize: 11, bold: true, color: BR });
  text(s, "Calendrier Parcoursup (vœux janv.-mars, admissions mai-juin) avec un dark saisonnalisé · YouTube Shorts en repost des 20 vidéos · kit prescripteurs sur LinkedIn (la 4e cible n'a aucun contenu dédié) · reporting unifié social + site chaque mois.", { x: 0.85, y: 6.2, w: 6.3, h: 0.65, fontSize: 9.3, color: INK, lineSpacingMultiple: 1.05 });
...
// ---------------------------------------------------------------- 9. CAP 2027
{
  ...
  bullets(s, [
    "12 mois d'accompagnement, sans trou d'inter-campagne : les abonnés stagnent dès que ça s'arrête",
    "18 publications / mois + 3 sets de stories, 80 % meunerie",
    "2 tournages (moulin + CFA) et 4 apprentis-ambassadeurs",
    "Dark ads saisonnalisé sur Parcoursup et la rentrée, optimisé sur le lead",
    "Chantier site : 3 pages d'atterrissage, tunnel, SEO trimestriel",
    "Un dashboard social + site, lu ensemble chaque mois",
