...
Prends ton dernier mois et liste dix tâches de moins de 30 minutes que tu as répétées — publication, captures, relances, exports, classement de fichiers. Pour chacune, note sur trois points : répétitive, fréquente, sans jugement. Prends la mieux notée et applique la formule : temps gagné par mois multiplié par ton taux horaire, contre temps de mise en place plus coût de l'outil. Si elle se rembourse en moins de trois mois, pose-la aujourd'hui. Dans la plupart des cas, ce sera activer les relances automatiques de ton outil de facturation ou programmer ta semaine de posts en une session : vingt minutes de réglage, des heures récupérées dès ce mois-ci.
