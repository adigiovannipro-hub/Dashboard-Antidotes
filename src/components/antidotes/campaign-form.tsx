    ...
    <form action={formAction} className="space-y-5">
          ...
          {maps ? (
            <>
              ...
              <Field label="Pays" htmlFor="c-country">
                <Input id="c-country" name="country" maxLength={2} className="uppercase" defaultValue={config.source.country} />
              </Field>
            </>
          ) : (
            <>
              ...
              <Field label="Trafic mensuel minimum" htmlFor="c-tmin">
                <Input id="c-tmin" name="trafficMin" type="number" min={0} defaultValue={config.source.traffic_min ?? ""} />
              </Field>
              <Field label="Trafic mensuel maximum" htmlFor="c-tmax">
      ...
      <Panel>
        ...
        <PanelBody className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="Pays acceptés" htmlFor="c-countries" hint="codes séparés par des virgules">
            <Input id="c-countries" name="countries" defaultValue={config.filters.countries.join(", ")} />
          </Field>
